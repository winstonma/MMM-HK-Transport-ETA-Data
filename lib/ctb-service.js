...
class CTBService {
  ...
  async _collectStopDetails(stopRoutesMap) {
    ...
    const successfulStops = this.processor.processStopDetailsResults(stopDetailsResults);
   ...
   */
  async _saveRouteData(routeStops, successfulStops) {
   ...
   */
  _logCompletionSummary(successfulStopsCount, totalStops, saveErrors, routeSaveErrors) {
