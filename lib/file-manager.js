    ...
    try {
      ...
      for (const [routeNumber, routeInfo] of Object.entries(allRoutesData)) {
        ...
        if (routeMeta) {
          ...
          compactData.routes[routeNumber].I['1'].orig_tc = routeMeta.orig_tc;
          compactData.routes[routeNumber].I['1'].orig_en = routeMeta.orig_en;
          compactData.routes[routeNumber].I['1'].orig_sc = routeMeta.orig_sc;
          compactData.routes[routeNumber].I['1'].dest_tc = routeMeta.dest_tc;
          compactData.routes[routeNumber].I['1'].dest_en = routeMeta.dest_en;
          compactData.routes[routeNumber].I['1'].dest_sc = routeMeta.dest_sc;

          // For CTB outbound: destination -> origin (reversed)
          compactData.routes[routeNumber].O['1'].orig_tc = routeMeta.dest_tc;
          compactData.routes[routeNumber].O['1'].orig_en = routeMeta.dest_en;
          compactData.routes[routeNumber].O['1'].orig_sc = routeMeta.dest_sc;
          compactData.routes[routeNumber].O['1'].dest_tc = routeMeta.orig_tc;
          compactData.routes[routeNumber].O['1'].dest_en = routeMeta.orig_en;
          compactData.routes[routeNumber].O['1'].dest_sc = routeMeta.orig_sc;
        }
        ...
        for (const stop of inboundStops) {
          ...
          compactData.routes[routeNumber].I['1'].stops.push(stopId);
        ...
        for (const stop of outboundStops) {
          ...
          compactData.routes[routeNumber].O['1'].stops.push(stopId);
